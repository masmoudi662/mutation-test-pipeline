...
FINAL_COMPARISON_CSV = BASE_DIR / "artifacts" / "final_comparison_latest.csv"
REPRODUCIBLE_SUBSET_CSV = BASE_DIR / "artifacts" / "reproducible_subset.csv"
GENERATED_TESTS_DIR = BASE_DIR / "experiments" / "generated_tests"
SUMMARY_CSV = BASE_DIR / "artifacts" / "mutation_summary_all_runs.csv"
BUILD_PATCHES_DIR = BASE_DIR / "artifacts" / "build_patches"
...
def write_condition_artifact(
    ...
    target_dir = BASE_DIR / "artifacts" / "per_repo" / repo_id / _module_as_path(module) / condition
